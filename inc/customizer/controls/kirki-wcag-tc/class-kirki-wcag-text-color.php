...
class Kirki_WCAG_Text_Color extends WP_Customize_Control {
	...
	public function to_json() {
		...
		if ( ! isset( $this->json['choices']['show'] ) ) {
			$this->json['choices']['show'] = [
				'auto'        => true,
				'recommended' => true,
				'custom'      => true,
			];
